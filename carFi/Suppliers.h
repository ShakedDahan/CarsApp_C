...
int addNewSupplier(Tree tree, char busNum[11],char* name,char phone[11],int num_transactions,long total_transactions);
...
long averageOfSupplierMoney(Tree_Node* head, int numOfSuppliers);
